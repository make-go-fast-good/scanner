...
const cols = {
    "condensed": [
        ...
        { title: "Read History", field: "bitField",
            "render": rowData =>
                        [...rowData.bitField.split("").map(char =>
                        char === "0"
                            ? <div style={{display:"inline-block",  margin: "1px", width: 3, height: 24, backgroundColor: "limegreen "}}></div>
                            : <div style={{display:"inline-block", margin: "1px", width: 3, height: 24, backgroundColor: "red "}}></div>
                    )],
