...
class TT31 extends Component {
  ...
  getData = (area) => {
    ...
    axios
      .get("http://localhost:8080/TT31/connect", {
        params: {
          area: area
        }
      })
      ...
      <Router>
        <div className="App">
          <div className="container">
            ...
            <Route path="/TT13" component={TT13}></Route>{" "}
            <Route path="/TT19" component={TT19}></Route>{" "}
            <Route path="/TT31" component={TT31}></Route>{" "}
          </div>{" "}
        </div>{" "}
      </Router>
    );
